    ...
    <div class="content">
        ...
        ?>
          ...
          // print_r($coursedt);
           ...
           ?>
  <?php echo form_open(base_url( 'ourgallery/galleryedit/'.$coursedt->id ), array( 'id' => 'courseadd', 'method'=>'POST','enctype'=> 'multipart/form-data' ));?>
        ...
        <div class="card-box">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control required_validation_for_product" value="<?php echo $coursedt->title; ?>" name="ctitle" placeholder="Enter  Gallery Heading Text" />
          </div>

          <div class="form-group">
            <label>Image Description</label>
            <input type="text" class="form-control required_validation_for_product" value="<?php echo $coursedt->short_desc; ?>" name="short_desc" placeholder="Enter the image description" />
          </div>

           <?php $fclss_dd='';
          if($coursedt->image){
             $fsrc='src="'.$coursedt->image.'"';
          }else{
            $fsrc='src="'.base_url().'assets/images/users/avatar-1.jpg"';
