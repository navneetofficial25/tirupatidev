...
<!--START Page-Title -->
            <div class="row">
                <div class="col-sm-12">
                <div class="col-md-8">
                   <h4 class="page-title">Car Models</h4><hr>
                  </div>
                  <div class="col-md-4">
                 </div>
...
<!--Delete-->
   ...
   <!--Delete-->
    ...
    <?php echo form_open(base_url('admin/cardetails/deletemodel'), array('method'=>'post'));?>
...
<script>
  $(document).ready(function() {
    $('#lowinventory').DataTable( {
        "ajax": "<?php echo base_url(); ?>admin/Cardetails/modeladdinventory_api"
    } );
...
$('#formSubmit').click(function() {
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>admin/Cardetails/addmodel",
        type: 'POST',
