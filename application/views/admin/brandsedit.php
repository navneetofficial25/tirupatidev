    ...
    <div class="content">
        <div class="container">
           <!--START Page-Title -->
            ...
            <div class="row">
                <div class="col-sm-12">
                <div class="col-md-8">
                   <h4 class="page-title">Edit Clients </h4><hr>
                  </div>
        ...
        ?>
          ...
          // print_r($coursedt);
           ...
           ?>
  <?php echo form_open(base_url( 'admin/brands/galleryedit/'.$coursedt->id ), array( 'id' => 'courseadd', 'method'=>'POST','enctype'=> 'multipart/form-data' ));?>
