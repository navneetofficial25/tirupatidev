  ...
  <?php echo form_open(base_url('admin/sitedesc/slidereditsve'), array( 'id' => 'courseadd', 'method'=>'POST','enctype'=> 'multipart/form-data' ));?>
        ...
        <div class="card-box">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control required_validation_for_product"  value="" name="name" placeholder="Enter  something About Us" />
          </div>

          <div class="form-group">
            <label>About Us </label>
         <textarea rows="20" cols="70" class="" name="cdesc" id="mytextarea" placeholder="About Us " ></textarea>
           </div>
           <div class="form-group">
            <label>Course Image <sup>*</sup></label>
           <input type="file"  id="fileupload" class="form-control"  name="images" style="border:0px solid !important;padding: 7px 0px 0px 0px;" />
           </div>
           ...
           <span  class="dvPreview" id="dvPreview" >
             ...
             <img  class="thunbnail_image images_preview"  />
             </span>
          </div>
