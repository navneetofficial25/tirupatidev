...
<div class="content-page">
  ...
  <?php echo form_open(base_url( 'admin/brands/galleryadd' ), array( 'id' => 'galleryadd', 'method'=>'POST','enctype'=> 'multipart/form-data' ));?>
        ...
        <div class="card-box">
          ...
          <div class="form-group">
           ...
           <span  class="dvPreview" id="dvPreview" >
             ...
             <img  class="thunbnail_image images_preview" src="<?=base_url();?>assest/img/PngItem_690697.png"/>
             </span>
          </div>
