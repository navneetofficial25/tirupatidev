                ...
                <div class="sho">
                    <div class="row">
                        <div class="col-md-4" style="margin-right: -10px;">
                            <img src="assest/img/health-insurance-top-up.jpg" width="110%" style="border-radius: 10px 0px 0px 0px;">
                            <div class="to">
                                <div class=" small">
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group date">
                                                ...
                                                <input type="text"  id="usr" name="username" placeholder="Enter Registration Number">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                ...
                                                <input list="companies" class="lis"  id="comp" name="username" placeholder="Enter Manufacturer ">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="types"  class="lis"   id="type" name="username" placeholder="Enter Fuel Type">
                                                <datalist id="types">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input type="text"  id="usr" name="username" placeholder="Select a Registration year">
                                                
                                            </div>
                                            <div class="form-group date">
                                                <label class="adults" for="ptype">Select Previous Policy Type</label>
                                                <input list="ptypes"   class="lis"  id="ptype" name="username" placeholder="Enter Policy Type">
                                                <datalist id="ptypes">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                ...
                                                <input list="modals"  class="lis"   id="modal" name="username" placeholder="Enter Model">
                                                <datalist id="modals">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="varis"  class="lis"   id="vari" name="username" placeholder="Enter Varient">
                                                <datalist id="varis">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="pexpires"  class="lis"   id="pexpire" name="username" placeholder="Not Expire">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="pinsurs"  class="lis"   id="pinsur" name="username" placeholder="Select Insurer">
                                                <datalist id="pinsurs">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group date">
                                                ...
                                                <input type="text"  id="us" name="username" placeholder="Enter Registration Number">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                ...
                                                <input list="compaies" class="lis"  id="comps" name="username" placeholder="Enter Manufacturer ">
                                                <datalist id="compaies">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                                    <option value="Opera">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="tpes"  class="lis"   id="typ" name="username" placeholder="Enter Fuel Type">
                                                <datalist id="tpes">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input type="text"  id="r" name="username" placeholder="Select a Registration year">
                                                
                                            </div>
                                            <div class="form-group date">
                                                <label class="adults" for="ptpe">Select Previous Policy Type</label>
                                                <input list="ptpes"   class="lis"  id="ptpe" name="username" placeholder="Enter Policy Type">
                                                <datalist id="ptpes">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                ...
                                                <input list="modls"  class="lis"   id="modl" name="username" placeholder="Enter Model">
                                                <datalist id="modls">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="vars"  class="lis"   id="var" name="username" placeholder="Enter Varient">
                                                <datalist id="vars">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="pexires"  class="lis"   id="pexire" name="username" placeholder="Not Expire">
                                                <datalist id="pexires">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
                                            ...
                                            <div class="form-group date">
                                                ...
                                                <input list="pisurs"  class="lis"   id="pisur" name="username" placeholder="Select Insurer">
                                                <datalist id="pisurs">
                                                    <option value="Edge">
                                                    <option value="Firefox">
                                                    <option value="Chrome">
